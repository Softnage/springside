...
@section('page_head')
	{!! seo([
		'title' => "Lower Primary | " . content('app.name')
		]) !!}
		...
		<div class="page-banner ovbl-dark" style="background-image:url(assets/ssa_images_copy/IMG_6115.JPG);">
			<div class="container">
				<div class="page-banner-entry">
					<h1 class="text-white">Lower Primary</h1>
				</div>
			</div>
		</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-8 col-md-12">
							...
							<img src="https://picsum.photos/600/350" alt="Lower Primary | {{ content('app.name') }}" style="width:100%; margin:20px 0;" />
