        ...
        <div class="container">
            <div class="row d-flex justify-content-between">
                <div class="topbar-left">
                    <ul>
                        <li>
                            <a href="{{ route('admission_procedure') }}"><i class="fas fa-question-circle"></i>How to
                                Apply</a>
                        </li>
                        <li>
                            <a href="mailto:{{ content('app.contact_email') }}"><i
                                    class="fas fa-envelope-o"></i>{{ content('app.contact_email') }}</a>
                        </li>
                    </ul>
                </div>
                <div class="topbar-right">
                    <ul>
                        ...
                        <li><a href="tel:{{ content('app.admissions_phone') }}">Admission Enquiries:
                                {{ content('app.admissions_phone') }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container clearfix">
                ...
                <div class="secondary-menu">
                    <div class="secondary-inner">
                        <ul>
                            <li>
                                <a href="{{ content('app.social.twitter.address') }}" target="_blank"><i
                                        class="fab fa-twitter"></i></a>
                            </li>
                            <li>
                                <a href="{{ content('app.social.instagram.address') }}" target="_blank"><i
                                        class="fab fa-instagram"></i></a>
                            </li>
                            <li>
                                <a href="{{ content('app.social.facebook.address') }}" target="_blank"><i
                                        class="fab fa-facebook"></i></a>
                            </li>
                            <li>
                                <a href="{{ content('app.social.linkedin.address') }}" target="_blank"><i
                ...
                <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="add-mega-menu @if (in_array(Request::fullUrl(), [route('about'), route('vision'), route('school_policies')])) active @endif">
                            ...
                            <ul class="sub-menu add-menu">
                                ...
                                <li class="add-menu-right">
                                    <img class='img-thumbnail' src="{{ asset('images/nav/about.jpg') }}"
                                        alt="" />
                                </li>
                            </ul>
                        </li>
                        <li class="add-mega-menu @if (in_array(Request::fullUrl(), [route('fees'), route('admission_procedure'), route('admission_policy')])) active @endif">
                            ...
                            <ul class="sub-menu add-menu">
                                ...
                                <li class="add-menu-right">
                                    <img class='img-thumbnail' src="{{ asset('images/nav/admissions.jpg') }}"
                                        alt="" />
                                </li>
                            </ul>
                        </li>
                        <li class="add-mega-menu @if (in_array(Request::fullUrl(), [
                            ...
                            <ul class="sub-menu add-menu">
                                ...
                                <li class="add-menu-right">
                                    <img class='img-thumbnail' src="{{ asset('images/nav/academics.jpg') }}"
                                        alt="" />
                                </li>
                            </ul>
                        </li>
